...
class TestEstimatedImpact(unittest.TestCase):
    def test_estimated_impact(self):
        # Test case 1: Basic test with non-zero coefficients
        beta0 = 1.0
        beta1 = 0.5
        beta2 = 0.3
        std_err_beta2 = 0.1
        ...
        self.assertEqual(result, (expected_impact_non_college, expected_impact_college, expected_is_impact_different))

        # Test case 2: Test with zero coefficients
        beta0 = 0.0
        beta1 = 0.0
        beta2 = 0.0
        std_err_beta2 = 0.0
        ...
        # Test case 3: Test with negative coefficients
        beta0 = -1.0
        beta1 = -0.5
        beta2 = -0.3
        std_err_beta2 = 0.1
